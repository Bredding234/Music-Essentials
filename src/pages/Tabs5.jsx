...
//api.spotify.com/v1/me/playlists
      ...
      fetch(`https://api.spotify.com/v1/playlists/37i9dQZF1DWUzFXarNiofw`, authPlaylistParameters)
...
//api.spotify.com/v1/me/playlists
      //Get request with Artist ID grab all the from that artist
      fetch(`https://api.spotify.com/v1/playlists/37i9dQZF1DX4SBhb3fqCJd`, authPlaylistParameters)
        .then((response) => response.json())
        .then((data) => {   
        console.log( { data } ); // works(displays playlist based the specific one I passed it).
        setPlaylists2(data); 
...
//api.spotify.com/v1/me/playlists
      //Get request with Artist ID grab all the from that artist
      fetch(`https://api.spotify.com/v1/playlists/37i9dQZF1DX6VDO8a6cQME`, authPlaylistParameters)
        .then((response) => response.json())
        .then((data) => {   
        console.log( { data } ); // works(displays playlist based the specific one I passed it).
        setPlaylists3(data); 
...
//api.spotify.com/v1/me/playlists
      //Get request with Artist ID grab all the from that artist
      fetch(`https://api.spotify.com/v1/playlists/37i9dQZF1DWYmmr74INQlb`, authPlaylistParameters)
        .then((response) => response.json())
        .then((data) => {   
        console.log( { data } ); // works(displays playlist based the specific one I passed it).
        setPlaylists4(data); 
...
//api.spotify.com/v1/me/playlists
      //Get request with Artist ID grab all the from that artist
      fetch(`https://api.spotify.com/v1/playlists/37i9dQZF1DWXbttAJcbphz`, authPlaylistParameters)
        .then((response) => response.json())
        .then((data) => {   
        console.log( { data } ); // works(displays playlist based the specific one I passed it).
        setPlaylists5(data); 
...
<h1
      ...
      <br />
  {playlists2 && <img src={playlists2.images[0].url} className="absolute bottom-[-90%] left-20 w-[400px] h-[350px]"  /> } <br /> <br /> <br /> <br />
