...
import PlayerTemplate from "/src/component/PlayerTemplate";
import Title from "/src/component/Title";
import Time from "/src/component/Time";
import Progress from "/src/component/Progress";
import ButtonsBox from "/src/component/ButtonsBox";
import LoopCurrent from "/src/component/LoopCurrent";
import Previous from "/src/component/Previous";
import Play from "/src/component/Play";
import Pause from "/src/component/Pause";
import Next from "/src/component/Next";
import Shuffle from "/src/component/Shuffle";
import Volume from "/src/component/Volume";
import PlaylistTemplate from "/src/component/PlaylistTemplate";
import PlaylistItem from "/src/component/PlaylistItem";
import TagsTemplate from "/src/component/TagsTemplate";
import TagItem from "/src/component/TagItem";
import Search from "/src/component/Search";


import loopCurrentBtn from "/src/icons/loop_current.png";
import loopNoneBtn from "/src/icons/loop_none.png";
import previousBtn from "/src/icons/previous.png";
import playBtn from "/src/icons/play.png";
import pauseBtn from "/src/icons/pause.png";
import nextBtn from "/src/icons/next.png";
import shuffleAllBtn from "/src/icons/shuffle_all.png";
import shuffleNoneBtn from "/src/icons/shuffle_none.png";
...
`;
  ...
  return (
    <PageTemplate>
      ...
      {showPlaylist && (
        <PlaylistTemplate>
          {trackList?.sort((a, b) => (a.title > b.title ? 1 : -1))
            .map((el, index) => {
              if (
                filter.length === 0 ||
